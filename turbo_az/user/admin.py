...
from .models import (
    ...
    SeatCountChoices, OwnerCount, Brand, CarModel, TransmissionType, ImageCar,YearChoices, CarStatus, IsApproved
)

class CarAdmin(admin.ModelAdmin):
    form = CarForm
    list_display = ('brand', 'car_models', 'price', 'year', 'mileage', 'is_approved')
    search_fields = ('name', 'brand__name', 'car_models__name', 'year', 'price')
    list_filter = ('brand', 'car_models', 'fuel_type', 'transmission', 'is_approved')
    ...
    fields = ('user', 'brand', 'car_models', 'new_bord', 'mileage', 'mileage_unit', 'color', 'price', 'price_currency',
              ...
              'email', 'phone_number', 'transmission_type', 'car_status', 'is_approved')
